/**
 * AdminDashboard — Phase 3
 *
 * Layout:
 *  • Header + date greeting
 *  • 4 KPI stat cards
 *  • Bar chart (dept employees) + Line chart (monthly hiring trend)
 *  • Pie chart (top skills) + Activity feed
 */
    ...
    <div className="dash-page">
      ...
      <div className="stat-grid">
        <StatCard
          ...
          value={loading ? '—' : data?.total_employees?.toLocaleString()}
          icon="👥"
          accent="primary"
        ...
        <StatCard
          ...
          value={loading ? '—' : data?.total_applicants?.toLocaleString()}
          icon="📋"
          accent="purple"
        ...
        <StatCard
          ...
          value={loading ? '—' : data?.open_positions?.toLocaleString()}
          icon="💼"
          accent="warning"
          trend="Active job posts"
          loading={loading}
        />
        <StatCard
          label="Hired This Month"
          value={loading ? '—' : data?.hired_this_month?.toLocaleString()}
          icon="🎯"
          accent="success"
      ...
      <div className="dash-grid-3">
        ...
        <ChartPanel
          ...
          subtitle="Based on recent job descriptions"
          loading={loading}
          minHeight="280px"
        >
